...
plot_power_curves(design7_power, "Effect of 1 at a Single stratum, Normal Errors")
...
plot_power_curves(design9_power, "Effect of 1 at a Single stratum, Heteroskedastic Errors")
...
summarytab <- xtable(summary05, align = "rp{1.15in}|p{0.7in}|p{0.6in}p{0.8in}p{0.8in}p{0.8in}p{0.75in}",
       caption = "Empirical power at level $0.05$ for Gaussian simulated data",
       label = "tab:normal_power") 
print(summarytab, type="latex", file="../ms/fig/normal_simulation_power_summary.tex")
summarytab
```
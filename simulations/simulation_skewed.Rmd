...
plot_power_curves(design1_power, "Constant Additive Effect of 0.5")
...
plot_power_curves(design2_power, "Effect of 0.5 in a Single Stratum")
```
...
plot_power_curves(design3_power, "Constant Additive Effect of 0.5 \n Unpredictive baseline")
```
...
plot_power_curves(design4_power, "Constant Additive Effect of 0.5 \n Imbalanced Design")
```
...
plot_power_curves(design5_power, "Effect of 0.5 at a Single stratum \n Imbalanced Design")
```

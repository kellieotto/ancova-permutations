...
* ANOVA: we fit a linear model of response $Y_1$ on baseline $Y_0$, treatment $Z$, and a dummy for stratum.
...
summarytab <- xtable(summary05, align = "rp{1.25in}|p{0.7in}|p{0.6in}p{0.8in}p{0.8in}p{0.8in}p{0.75in}",
       caption = "Empirical power at level $0.05$ for discrete, skewed simulated data",
       label = "tab:skewed_power")
print(summarytab, type="latex", file="../ms/fig/skewed_simulation_power_summary.tex") 
summarytab 
```
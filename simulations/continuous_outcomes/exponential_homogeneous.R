...
tmp <- generate_simulated_data(gamma = 0.2, effect = "same effect", errors = "exponential")
...
exponential_homogeneous <- apply(pvalues, 2, compute_power)
save(exponential_homogeneous, file="exponential_homogeneous.Rda")
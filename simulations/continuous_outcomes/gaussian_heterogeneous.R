...
tmp <- generate_simulated_data(gamma = 0.2, effect = "heterogeneous", errors = "normal")
...
gaussian_heterogeneous <- apply(pvalues, 2, compute_power)
save(gaussian_heterogeneous, file="gaussian_heterogeneous.Rda")
...
tmp <- generate_simulated_data(gamma = 0.2, effect = "same effect", errors = "lognormal")
...
lognormal_homogeneous <- apply(pvalues, 2, compute_power)
save(lognormal_homogeneous, file="lognormal_homogeneous.Rda")
...
tmp <- generate_simulated_data(gamma = 0.2, effect = "heterogeneous", errors = "t")
...
t_heterogeneous <- apply(pvalues, 2, compute_power)
save(t_heterogeneous, file="t_heterogeneous.Rda")
...
tmp <- generate_simulated_data(gamma = 0.2, effect = "heterogeneous", errors = "x-correlated")
...
corr_errors_heterogeneous <- apply(pvalues, 2, compute_power)
save(corr_errors_heterogeneous, file="corr_errors_heterogeneous.Rda")
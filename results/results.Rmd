...
tests <- c("Parametric ANCOVA", "Unadjusted permutation", "Unadjusted permutation (summed across strata)", "Linear regression permutation", "Residual permutation")
...
tests <- c("Parametric ANCOVA", "Stratified permutation", "LM permutation", "Residual permutation")
